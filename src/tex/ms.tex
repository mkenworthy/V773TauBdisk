...
%
Using the approximations within \citet{Eggleton95}, we can calculate a lower limit for the periastron of C around the AB system, and then reject orbits from the orbital bundle produced from our fitting procedure. \RGM{This stability criteria is able to predict the stability over timescales of $5\times 10^5\,P_{AB}$ \citep{He2018}, much longer than the age of the system.}
% 
...
\begin{center}
    \centering
    \includegraphics[width=\columnwidth]{figures/particle.eps}
...
\begin{center}
    \centering
    \includegraphics[width=\columnwidth]{figures/compare.eps}
